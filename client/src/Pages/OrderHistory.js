...
function OrderHistory(props) {
    ...
    useEffect(() => {
        ...
        if (ordersBoxElement) {
            ordersBoxElement.style.height =
                winHeight - ordersBoxElement.offsetTop + "px";
        }
    });
    ...
    const pageMain = () => {
        if (loading || clientLoading) {
            ...
            return (
                <div>
                    <p className="orderAltText">
                        Something went wrong: {clientError.message}
                    </p>
                </div>
            );
        } else {
        ...
        <div>
            ...
            <main id="orderBox">
                ...
                <div id="orderHeader">
                    ...
                    <button id="addOrderButton" onClick={openModal}>
                        Add Order
                    </button>
                </div>
                {pageMain()}
            ...
            >
                ...
                <form id="addOrderForm" onSubmit={handleAdd}>
                    ...
                    <button id="modalOrderCancelButton" onClick={closeAndClear}>
                        Cancel
                    </button>
                </form>
            </Modal>
